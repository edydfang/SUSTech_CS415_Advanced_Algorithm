...
%   >> [makespan, assigns, accumulators] = greedy_balance(100, 1e3, 1 : 1e3, job_time); % 5481
    '''
    print(greedy_balance.greedy_balance(3,np.arange(1,8), np.arange(1,8)))
    print(greedy_balance.greedy_balance(3,np.arange(1,7), np.array([2,3,4,6,2,2])))
    print(greedy_balance.greedy_balance(4,np.concatenate((np.arange(2,14),np.array([1])),axis=0), np.concatenate((np.ones(12,dtype=np.int8),np.array([4])),axis=0)))
    print(greedy_balance.greedy_balance(3,np.arange(1,6), np.array([7,6,5,4,2])))
    print(greedy_balance.greedy_balance(3,np.arange(1,6), np.array([2,7,6,5,4])))
